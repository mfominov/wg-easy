...
| `WG_PRE_UP`               | `...`             | -                              | See [config.js](https://github.com/mfominov/wg-easy/blob/master/src/config.js#L19) for the default value.    |
| `WG_POST_UP`              | `...`             | `iptables ...`                 | See [config.js](https://github.com/mfominov/wg-easy/blob/master/src/config.js#L20) for the default value.    |
| `WG_PRE_DOWN`             | `...`             | -                              | See [config.js](https://github.com/mfominov/wg-easy/blob/master/src/config.js#L27) for the default value.    |
| `WG_POST_DOWN`            | `...`             | `iptables ...`                 | See [config.js](https://github.com/mfominov/wg-easy/blob/master/src/config.js#L28) for the default value.    |
